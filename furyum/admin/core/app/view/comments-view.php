                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="small" style="max-width: 300px;">
                                    <div class="text-truncate" title="<?php echo htmlspecialchars($c->comment); ?>">
                                ...
                                <td class="text-center">
                                    <?php if($c->status == 0): ?>
                                        <span class="badge bg-danger bg-opacity-10 text-danger rounded-pill"><i class="bi bi-shield-exclamation me-1"></i> Spam</span>
                                ...
                                <td class="small" style="max-width: 250px;">
                                    <?php if(!empty($c->spam_reason)): ?>
                                        <div class="text-truncate text-danger" title="<?php echo htmlspecialchars($c->spam_reason); ?>">
                                            <i class="bi bi-exclamation-triangle me-1"></i><?php echo htmlspecialchars($c->spam_reason); ?>
                                        </div>
                                    <?php else: ?>
                                ...
                                <td class="small text-muted">
                                    <?php echo !empty($c->ip_address) ? htmlspecialchars($c->ip_address) : '<span class="text-muted">—</span>'; ?>
                                </td>
                                ...
                                <td class="pe-4 text-end">
                                    ...
                                    <?php endif; ?>
                                    <?php if($c->status == 0): ?>
                                        <a href="index.php?action=comments&opt=accept&id=<?php echo $c->id; ?>" class="btn btn-light btn-sm text-success me-1" title="Aprobar (No es spam)">
                                            <i class="bi bi-check-circle me-1"></i>Aprobar
                                        </a>
                                    <?php endif; ?>
                                    <a href="index.php?action=comments&opt=del&id=<?php echo $c->id; ?>" class="btn btn-light btn-sm text-danger" title="Eliminar" onclick="return confirm('¿Estás seguro?')"><i class="bi bi-trash"></i></a>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
