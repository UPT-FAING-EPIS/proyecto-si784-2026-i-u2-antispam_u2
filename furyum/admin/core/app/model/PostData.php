...
class PostData {
	...
	public function add(){
		...
		$sql = "insert into ".self::$tablename." (title,brief,content,category_id,image,user_id,created_at,status) ";
		$sql .= "value (\"$title\",\"$brief\",\"$content\",$this->category_id,\"$this->image\",$this->user_id, NOW(), $this->status)";
